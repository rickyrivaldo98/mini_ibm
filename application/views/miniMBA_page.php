...
<body>
    ...
    <header id="site-header" class="fixed-top">
        <div class="container">
            <nav class="navbar navbar-expand-lg stroke">
                ...
                <h1><a class="nav-link" style="color:black" href="<?= base_url("Homepage"); ?>">Mini MBA</a></h1>
                ...
                <div class="collapse navbar-collapse " id="navbarTogglerDemo02">
                    <ul class="navbar-nav ml-lg-auto">
                        <li class="nav-item">
                            <a class="nav-link text-body" href="<?= base_url("Homepage/program"); ?>">Program</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link text-body" href="<?= base_url("Homepage/journal"); ?>">Insight & Journal</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link text-body" href="<?= base_url("Homepage/about"); ?>">About Us</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link text-body" href="<?= base_url("Homepage/events"); ?>">Events</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link text-body" href="<?= base_url("Homepage/news"); ?>">News</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link text-body" href="<?= base_url("Homepage/contact"); ?>">Contact Page</a>
                        </li>
                        <li class="nav-item">
    ...
    <section class=" w3l-call-to-action-6 ">
        <div class=" call-sec-style">
            <div class="d-flex container-mba justify-content-between">
            ...
            <div class="container py-md-4 py-3">
                <div class="content-sec-11 py-5 text-center" style="background-color: #F5F7FB;">
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            <div class="section-heading text-center mb-sm-5 mb-4">
                                <p>We prepare the best program to produce great leaders for the future <br> and welcome the acceleration of technology in Indonesia.</p>
                            </div>
                        </div>
                    </div>

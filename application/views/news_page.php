...
<body>
    ...
    <div class="inner-banner-news">
        <div class="w3l-breadcrumb">
            <div class="container">
                <h4 class="inner-text-title font-weight-bold text-white mb-sm-3 mb-2" style="text-align:left">latest news for you</h4>
                <p style="color:white;text-align:left !important">The latest news we present to you</p>
            </div>
        </div>
    </div>
    <!-- //inner banner -->
